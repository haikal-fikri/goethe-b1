...
// Gehärteter Proxy vor GoTrue signInWithOtp (teacher-lms Q4; spiegelt
// apps/web/api/auth/otp): per-E-Mail 3/10 min + per-IP 15/10 min (fail-closed)
// + Turnstile-Verify — ersetzt die reine IP-/projektglobale GoTrue-Grenze.
// Sendet Magic-Link (→ /auth/confirm) + 8-stellige OTP (→ Login-Seite verifiziert
// client-seitig via verifyOtp).
