...
import { enforce, getClientIp } from "./ratelimit";
...
//
// Der "preAuthIp"-Limiter muss von der app-eigenen lib/ratelimit-Registry
// bereitgestellt werden (registerLimiters). Der app-Shim importiert lib/ratelimit
// als Seiteneffekt, bevor requireUser läuft (siehe apps/*/src/lib/supabaseServer.ts).
