...
// (@supabase/ssr, Next 16). Ein NEUER Client pro Render/Request.
    ...
    cookies: {
      ...
      setAll(cookiesToSet) {
        try {
          ...
          // Server-Component-Render → Cookies read-only. proxy.ts refresht.
        }
      },
    },
  });
...
/** Verifizierter Nutzer (kontaktiert GoTrue) oder null. Für Autz-Entscheidungen. */
